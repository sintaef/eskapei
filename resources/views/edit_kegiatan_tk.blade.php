...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-body">
        <form method="POST" action="/edit-kegiatan/{id}">
          {!! csrf_field() !!}
            ...
            <div class="form-row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="textarea" disabled name="bk" value="{{$editnama=bidang}}">
                </div>
                <div class="form-group">
                  <label for="namakegiatan">Nama Kegiatan</label>
                  <input class="form-control" type="textarea" name="namakegiatan" value="{{$editnama=namakegiatan}}">
                </div>
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-4">
                    ...
                    <a href="/kegiatan_tkemahasiswaan" type="submit" class="btn btn-secondary">
                        Batal
                    </a>
                  </div>
                </div>
